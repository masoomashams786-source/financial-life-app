        ...
        <Accordion defaultExpanded>
          <AccordionSummary expandIcon={<ExpandMore />}>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Typography fontWeight={600}>Strengths ({strengths?.length || 0})</Typography>
            </Box>
          </AccordionSummary>
          <AccordionDetails>
            {strengths && strengths.length > 0 ? (
              <Box display="flex" flexDirection="column" gap={2}>
                {strengths.map((strength, idx) => (
                  <Box key={idx}>
                    <Typography variant="body2" fontWeight={600} color="#10B981" mb={0.5}>
                      ✓ {strength.title}
                    </Typography>
        ...
        <Accordion>
          <AccordionSummary expandIcon={<ExpandMore />}>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Typography fontWeight={600}>Vulnerabilities ({vulnerabilities?.length || 0})</Typography>
            </Box>
          </AccordionSummary>
          <AccordionDetails>
